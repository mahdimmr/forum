...
final fortniteTopics = [
  Topic(
    ...
    recentAnswer: "I hear this question often, so I figured I'd start thread. When I drop ",
    answerCount: "1241"
  ),
  Topic(
    question: "Quitting FN because of this?",
    recentAnswer: "Literally done with game until they balance the map better so that blue",
    answerCount: "238"
  ),
];
